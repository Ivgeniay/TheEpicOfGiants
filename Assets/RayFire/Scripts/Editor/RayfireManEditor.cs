    ...
    public class RayfireManEditor : Editor
    {
        ...
        void UI_Pooling()
        {
            ...
            if (man.fragments.enable == true)
            {
                ...
                EditorGUI.BeginChangeCheck();
                man.fragments.minCap = EditorGUILayout.IntSlider (gui_pl_min, man.fragments.minCap, 0, 3000);
                if (EditorGUI.EndChangeCheck() == true)
                    SetDirty (man);
                ...
                if (man.fragments.reuse == true)
                {
                    ...
                    EditorGUI.BeginChangeCheck();
                    man.fragments.maxCap = EditorGUILayout.IntSlider (gui_pl_max, man.fragments.maxCap, 0, 3000);
                    if (EditorGUI.EndChangeCheck() == true)
                        SetDirty (man);
                }
            }
